...
urlpatterns = [
    ...
    re_path(r'recipe/(?P<slug>[-\w]+)/', views.recipe_view, name='recipe'),
    path('recipe_new/', views.recipe_new, name='recipe_new'),
    re_path(r'recipe_edit/(?P<slug>[-\w]+)/', views.recipe_edit, name='recipe_edit'),
    re_path(r'recipe_delete/(?P<slug>[-\w]+)/', views.recipe_delete, name='recipe_delete'),
